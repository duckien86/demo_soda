<?php
    ...
    class UploadHandler
    {
        ...
        protected $error_messages = array(
            ...
            'image_resize'        => 'Ảnh đã được tải lên.Nhưng không thể giảm kích cỡ'
        );
        ...
        protected function get_upload_path($file_name = null, $version = null)
        {
            ...
            return $this->options['upload_dir'] . $this->options['begin_dir'] . $this->get_user_path()
        ...
        protected function get_download_url($file_name, $version = null, $direct = false)
        {
            ...
            return $this->options['upload_url'] . $this->options['begin_dir'] . $this->get_user_path()
                                         ...
                                         $index, $content_range)
        {
            ...
            $name = str_replace('(', '', $name);
            $name = date('dmHis') . rand(0, 1000) . strtolower($this->unsign_string($name, '-', '.'));
                                              ...
                                              $index = null, $content_range = null)
        {
            ...
            if ($this->validate($uploaded_file, $file, $error, $index)) {
                ...
                $upload_dir      = $this->get_upload_path();
                //$auto_render_dir = $this->options['begin_dir'];
                //$upload_dir      = $upload_dir . $auto_render_dir;
                if (!is_dir($upload_dir)) {
