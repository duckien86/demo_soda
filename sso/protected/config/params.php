<?php
    ...
    return array(
        'elastic_config'    => array(
            'index' => 'citv',           //<=> DB in mysql
            'hosts' => array(
                '192.168.10.4:9201', //default host:ip
            ),
        ),
...
//        'url_root' => 'http://localhost/citv/',


        'upload_url'      => 'http://localhost/citv/',
        'upload_dir_path' => '../uploads/',
        'dir_videos'      => 'videos/',
        'dir_categories'  => 'categories',
        'secret_key'      => '6LdnWS4UAAAAAC0dqaCf-DAOvgvPXdHe_RfNyb0Y', //recapcha secret key

        'url_svecom' => 'https://freedoo.vnpt.vn/affiliate/api/user/create',
//        'url_svecom' => 'http://118.70.177.77:8694/affiliates/api/user/create', //recapcha secret key
        //--------------> IP_MAP_3G <--------------//
        'IP_MAP_3G'  => array(
