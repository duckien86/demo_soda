                ...
                <div class="col-md-8 col-md-pull-4 no_pad_xs">
                    <div id="main_left_section" class="msg">
                        ...
                        <div>
                            ...
                            <?php echo CHtml::link('Nhận hóa đơn điện tử',
                                Yii::app()->controller->createUrl('einvoice/create', array(
                                    'order_id' => $order_id,
                                    'key' => $key,
                                )),
                            ...
                            <?php $esim = Yii::app()->session['type_sim']; ?>
                            <?php if($esim){ ?>
                                <p>Đơn hàng dự kiến sẽ được giao cho Quý khách từ ngày 28/2/2019.  Vui lòng mang theo Mã đơn hàng và
...
<div id="survey">
    <?php $this->renderPartial('/survey/_modal_confirm', array('order_id' => Yii::app()->session['message_order']['order_id'])); ?>
</div>