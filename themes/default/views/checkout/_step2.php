...
<div class="form sim_checkout">
    <?php if(!empty($modelOrder->promo_code) && $modelOrder->promo_code != "P9207835"):?>
    <div class="font_15">
    ...
    <div class="panel-checkout step-payment">
        <?php $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
            'id'                   => 'form_step2',
            'action'               => Yii::app()->controller->createUrl('checkout/checkout2'),
        ...
        <div class="main_left_section-actions">
            ...
            <div class="text-center">
                <a href="<?= Yii::app()->controller->createUrl('checkout/checkout'); ?>" class="btn btn_return">
                    Quay lại
                </a>
