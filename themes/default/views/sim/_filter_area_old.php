...
<div class="ss-box1-left-top-4 form">
    ...
    <div class="row">
        ...
        <div class="col-md-11 col-sm-10 col-xs-8">
            <div id="list_source">
                <a href="<?php echo Yii::app()->createUrl('sim/index', array('source' => ''));?>" class="btn <?php echo (empty($searchForm->source)) ? 'active' : ''?>" data-value="">FREEDOO</a>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-8 selectbox input_msisdn">
