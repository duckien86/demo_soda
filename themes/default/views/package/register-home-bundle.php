        ...
        <div class="col-lg-8">
            <div class="form-reg-fiber pad-20">
                ...
                <?php $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
                    'id' => 'form_register_home_bundle',
                    'action' => Yii::app()->controller->createUrl('package/registerHomeBundle', array('package' => $modelPackage->id)),
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-2"></div>
                            <div class="col-lg-8">
                                <input type="hidden" value="<?php echo CHtml::encode($modelPackage->code_vnpt) ?>"
                                       id="dichvu">
                    ...
                    <div class="col-lg-12" style="text-align: center">
                        ...
                        <?php } else { ?>
                            <a class="btn btn-register"
                               ...
                               data-toggle="modal" data-target="#previeworder">Đăng ký
                            </a>
                            <!-- Modal -->
