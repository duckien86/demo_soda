...
<div id="packages" class="page_detail">
    ...
    <?php $this->renderPartial('/package/_block_banner_mytv'); ?>
    <section class="ss-bg">
            ...
            <div class="no_pad_xs">
                <div class="ss-box1-right-all">
                    <div class="package_filter_area_container">
                        <div class="container">
                            <?php $this->renderPartial('/package/_filter_area_mytv', array('searchPackageForm' => $searchPackageForm, 'package_search_filter' => true,'list_province'=>$list_province)) ?>
<!--                            <div id="packages_tabs" class="tab-content content">-->
<!--                                --><?php //$this->renderPartial('/package/_block_package_mytv', array(
