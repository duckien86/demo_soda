    ...
    <div class="item_package">
        <div class="title">
            <a href="<?php echo Yii::app()->controller->createUrl('package/detail', array('slug' => $model->slug)); ?>">
                ...
                <p><?php echo CHtml::encode(WPackage::model()->getPackageTypeLabel($model->type)); ?></p>
                    ...
                    foreach ($list_short_des as $short_des) {
                        ...
                        if (!empty($short_des)) {
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                            <span class="package_icon">
                                <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/check.png"
        ...
        <div class="price">
            ...
            <?php echo CHtml::encode(number_format($price, 0, ',', '.')) ?>
            <sup>đ</sup><span><?php echo '/' . WPackage::model()->getPackagePeriodLabel($model->period) ?></span>
        </div>
        ...
        <div class="action text-center">
            <?php if ($model->name == 'HEY' || $model->name == 'HEYTIIN' || $model->name == 'FTIN' || $model->name == 'FLY') { ?>
                <a href="" class="btn btn-register" data-toggle="modal"
                   data-target="#showmodal_<?php echo $model->slug ?>">
...
<!-- Modal -->
<div class="modal fade" id="showmodal_<?php echo $model->slug ?>" role="dialog">
    <div class="modal-dialog modal-sm modal-custom">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="ct-tb">Gói cước chỉ dành cho thuê bao Gshop hòa mạng mới. Vui lòng chọn sim mới để đăng ký gói cước hấp dẫn này.</p>
            </div>
