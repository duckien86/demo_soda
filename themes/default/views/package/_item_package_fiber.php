    ...
    <div class="item_package item_package_fiber">
        ...
        <div class="action text-center cus-btn">
            ...
            <?php if ($model->freedoo == 0) { ?>
                <a href="<?php echo Yii::app()->controller->createUrl('package/registerfiberallprovince', array('package' => $model->id)); ?>"
            ...
            <?php } elseif ($model->freedoo == 1 || $model->freedoo == 2) { ?>
                <a href="<?php echo Yii::app()->controller->createUrl('package/registerfibers', array('package' => $model->id)); ?>"
                   class="btn btn-register" onclick="nonepopup();">
                    Đăng ký
                </a>
            <?php } ?>
