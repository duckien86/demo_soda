                        ...
                        <div class="form">
                            ...
                            <h3 class="title text-center">
                                ...
                                gói <span class="lbl_color_blue"><?= number_format($modelPackage->price, 0, "", ".") ?>
                                    đ</span>.<br><br>
                                <h5 style="text-align: center;">Mã xác thực OTP vừa được gửi đến số điện thoại của bạn,
                                    vui lòng nhập mã OTP để xác nhận đăng ký.</h5>
                            </h3>
                            ...
                            <div class="form-group text-center">
                                <?php echo $otpForm->labelEx($otpModel, 'token', array('class' => 'label_text')); ?>
