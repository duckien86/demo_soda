    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="form-reg-fiber pad-20">
                <div class="alert alert-success" style="background: #ed0677!important; color: #fff !important; border-radius: 0px !important;padding: 10px;border: 1px #ed0677 solid;">
                    <strong>Thông tin đăng ký gói cước</strong>
                </div>
                <?php $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
                    'id' => 'form_register_combo_all_province',
                    'action' => Yii::app()->controller->createUrl('package/registercomboallprovince', array('package' => $modelPackage->id)),
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-2"></div>
                            <div class="col-lg-8">
                                <input type="hidden" value="<?php echo CHtml::encode($modelPackage->code_vnpt) ?>" id="dichvu">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php
                                        if ($modelPackage->service_type == WPackage::INSTANT_PAYMENT) {
                                            $function = '$("#WRegFiber_phuong_id").select2("val", "");getRestricedApartment()';
                                        } else {
                                            $function = '$("#WRegFiber_phuong_id").select2("val", "");';
                                        }
                                        $this->widget(
                                            'booster.widgets.TbSelect2',
                                            array(
                                                ...
                                                'htmlOptions' => array(
                                                    ...
                                                    'ajax' => array(
                                                        'type' => 'POST',
                                                        'dataType' => 'json',
                                                        'url' => Yii::app()->controller->createUrl('package/getWardBrandOfficesByDistrictAllProvince'),
                                                        'success' => 'function(data){
                                                            $("#WRegFiber_phuong_id").html(data.html_ward);
                                                        }',
                                                        'data' => array('quan_id' => 'js:this.value', 'YII_CSRF_TOKEN' => Yii::app()->request->csrfToken),
                                                        'timeout' => 5000
                                                    ),
                                                    'onchange' => $function
                                                ),
                        ...
                        <div class="row custom-row">
                            ...
                            <div class="col-12 col-xs-12 col-md-6col-sm-6 col-lg-6">
                                <div class="wrap-radio">
                                    <label class="radio-inline"><input onclick="getPho()" value="1" type="checkbox" id="WRegFiber_chose_street" name="WRegFiber[chose_street]">Phố</label>
                                    <label class="radio-inline"><input onclick="getAp()" value="2" type="checkbox" id="WRegFiber_chose_street1" name="WRegFiber[chose_street]">Ấp</label>
                                    <label class="radio-inline"><input onclick="getKhu()" value="3" type="checkbox" id="WRegFiber_chose_street2" name="WRegFiber[chose_street]">Khu</label>
                                </div>
                                <div class="wrap-radio">
                        ...
                        <!-- thêm chọn chung cư  -->
                        <?php if ($modelPackage->service_type == WPackage::INSTANT_PAYMENT) : ?>
                            <div class="row custom-row">
                                <div class="col-lg-2"></div>
                                <div class="col-12 col-xs-12 col-md-6 col-sm-6 col-lg-6">
                                    <div>
                                        <label> Bạn có đang ở chung cư trong danh sách dưới đây không? <span style="color: red">(*)</span></label><br>
                                        <!-- <label class="radio-inline">
                                            <input onclick="getRestricedApartment()" value="1" type="radio" id="WRegFiber_is_restricted_aparment_1" name="WRegFiber[is_restricted_apartment]"> Đúng
                                        </label>
                                        <label class="radio-inline">
                                            <input onclick="getRestricedApartment()" value="0" type="radio" id="WRegFiber_is_restricted_aparment_0" name="WRegFiber[is_restricted_apartment]"> Không đúng
                                        </label> -->
                                        <?php echo $form->error($modelRegFiber, 'is_restricted_apartment'); ?>
                                        <label id="restricted_apartment_id_tip" style="color: red; font-size:9px;"> Gói cước này không áp dụng cho một số chung cư trong danh sách bên dưới. Vui lòng kiểm tra. </label>
                                        ...
                                        $this->widget(
                                            ...
                                            array(
                                                'model' => $modelRegFiber,
                                                'attribute' => 'restricted_apartment_id',
                                                'data' => null,
                                                'htmlOptions' => array(
                                                    'multiple' => FALSE,
                                                    'prompt' => 'Chọn tên chung cư bạn đang ở',
                                                    // 'style' => 'display:none',
                                                    // 'onclick' => 'getRestricedApartment()',
                                                ),
                                            )
                                        );
                                        ?>
                        ...
                        <div class="row" id="address_detail">
                            <div class="col-lg-2"></div>
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin-bottom: 20px; margin-top: 20px">
                        <span style="font-weight: bold; margin-left: 40px; font-size: 15px; margin-bottom: 40px; width: 100%">Thông tin người yêu cầu/giới thiệu (nếu có) </span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12" style="text-align: center">
                        <?php if (!$isMobile) { ?>
                            <button class="btn btn-register" style="background: #ed0677 !important; color: #fff; margin-top: 20px">Đăng ký
                            </button>
                        <?php } else { ?>
                            <a class="btn btn-register" style="background: #ed0677 !important; color: #fff; margin-top: 20px" data-toggle="modal" data-target="#previeworder">Đăng ký
                            </a>
                            <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body content-order-fiber-mobile">
                                            ...
                                            <div class="w100">
                                                ...
                                                <div class="w50">
                                                    <?php if ($modelPackage->price_discount) { ?>
                                                        <?php echo number_format($modelPackage->price_discount) . ' VNĐ' ?>
                                                    <?php } else { ?>
                                                        <?php echo number_format($modelPackage->price) . ' VNĐ' ?>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="w100">
                                            ...
                                            <div class="w100">
                                                <div class="w50">Hình thức thanh toán :</div>
                                                <div class="w50">
                                                    <div id="">COD</div>
                                                </div>
                                            </div>
                                            <div class="w100" style="<?php if ($modelPackage->commercial && $modelPackage->commercial !== '') {
                                                                            echo 'color:red';
                                                                        } ?>">
                                        ...
                                        <div class="modal-footer modal-footer-mobile">
                                            ...
                                            <button class="btn btn-register" style="background: #ed0677 !important; color: #fff">Xác nhận
                                            </button>
                                        </div>
                                    </div>
        ...
        <?php if (!$isMobile) { ?>
            <div class="col-lg-4" id="keeprelative">
                <div id="keepposition">
                    <div class="preview-reg-fiber pad-20">
                        ...
                        <div class="row" style="font-weight: bold; font-size: 12px; margin-bottom: 10px">
                            <div class="col-lg-6">Hình thức thanh toán :</div>
                            <div class="col-lg-6">
                                <div>COD</div>
                            </div>
                        </div>
                        <div class="row" style="font-weight: bold; font-size: 12px; margin-bottom: 10px ;<?php if ($modelPackage->commercial && $modelPackage->commercial !== '') {
                                                                                                                echo 'color:red';
                                                                                                            } ?>">
...
<script>
    ...
    function getPho() {
        ...
        if (checked == true) {
            ...
            $.ajax({
                ...
                url: '<?= Yii::app()->controller->createUrl("package/getStreetFiberTQ"); ?>',
                method: 'POST',
                data: {
     ...
     * Hiện chung cư
     */
    function getRestricedApartment() {
        // var checked = document.getElementById('WRegFiber_is_restricted_aparment_1').checked;
        // if (checked == 1) {
        // document.getElementById("s2id_WRegFiber_restricted_apartment_id").style.display = "block";
        district_id = document.getElementById('WRegFiber_quan_id').value;
        // document.getElementById("address_detail").style.display = "none";

        $.ajax({

            url: '<?= Yii::app()->controller->createUrl("package/getRestricApartment"); ?>',
            method: 'POST',
            data: {
                'YII_CSRF_TOKEN': '<?php echo Yii::app()->request->csrfToken ?>',
            ...
            success: function(data) {
                $('#WRegFiber_restricted_apartment_id').html(data.content);
            }
        });

        // } else {
        //     // document.getElementById("s2id_WRegFiber_restricted_apartment_id").style.display = "none";
