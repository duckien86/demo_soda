...
<?php $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id'                   => 'form_verify_otp_rx',
    'action'               => Yii::app()->controller->createUrl('roaming/registerRx'),
    'enableAjaxValidation' => TRUE,
    'htmlOptions'          => array('onsubmit' => 'return false;'),
)); ?>
<div class="text-center font_bold font_15">
    Quý khách vui lòng nhập mã OTP vừa nhận được qua SMS để hoàn tất đăng ký gói cước
...
<script>
    //    $(document).on('submit', '#form_verify_otp_rx', function (e) {
    $('#modal_roaming').unbind('submit').on('submit', '#form_verify_otp_rx', function (e) {
        e.preventDefault();
