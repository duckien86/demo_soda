...
<div class="text-center font_15">
    Quý khách muốn hủy gói cước Roaming đang sử dụng, vui lòng nhập SĐT để nhận mã hủy
</div>
<div class="space_20"></div>
<?php $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id'                   => 'form_send_otp_cancel',
    'action'               => Yii::app()->controller->createUrl('roaming/sendOtpCancel'),
...
<script>
    $('#modal_roaming').unbind('submit').on('submit', '#form_send_otp_cancel', function (e) {
