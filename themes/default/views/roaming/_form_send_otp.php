...
<div class="text-center font_15">
    Quý khách vui lòng nhập SĐT để nhận mã tra cứu thông tin các gói cước Roaming đang sử dụng
</div>
<div class="space_20"></div>
<?php $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id'                   => 'form_send_otp',
    'action'               => Yii::app()->controller->createUrl('roaming/sendOtpSearch'),
...
<script>
    $('#modal_roaming').unbind('submit').on('submit', '#form_send_otp', function (e) {
