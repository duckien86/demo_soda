...
<div class="order_form_wizard clearfix">
    <ul>
        <li class="<?php echo $this->getStepTagClass(OrderCtvController::STEP_FILL_ORDER)?>">
        ...
        <li class="<?php echo $this->getStepTagClass(OrderCtvController::STEP_CONFIRM_ORDER)?>">
            <a class="<?php echo $btnClass ?>">
        ...
        <li class="<?php echo $this->getStepTagClass(OrderCtvController::STEP_COMPLETE_ORDER)?>">
            <a class="<?php echo $btnClass ?>">
