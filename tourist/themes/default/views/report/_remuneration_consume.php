...
?>
    ...
    <?php if(isset($data) && !empty($data)): ?>
        ...
        <div class="row" style="margin-top: 20px">
            <div class="col-sm-8">
                <div class="title">
                    <h5>* Tổng quan thù lao tiêu dùng tài khoản chính</h5>
                </div>
...
//                            'footerHtmlOptions' => array('style' => 'text-align: right'),
    ...
    <?php if( isset($data_detail) && $model->on_detail == 'on' ): ?>

    <div class="row" style="margin-top: 20px">
            <div class="col-sm-12">

                <div class="right">
                    <form method="post" action="<?php echo Yii::app()->createUrl('excelExport/reportDetailRemunerationConsume')?>" target="_blank">
                ...
                <div class="title">
                    <h5>* Chi tiết thù lao tiêu dùng tài khoản chính</h5>
                </div>
                <?php $this->widget('booster.widgets.TbGridView', array(
                    ...
                    'columns'           => array(
                        ...
                        array(
                            'header'        => 'Ngày đặt đơn hàng',
                            'filter'        => false,
                            'type'          => 'raw',
                            'value'         => function($data){
                                $value = '';
                                if(!empty($data->order_time)){
                                    $value = date('d-m-Y H:i:s', strtotime(str_replace('/', '-', $data->order_time)));
                                }
                                return $value;
                            },
...
//                        array(
//                            'header'        => Yii::t('tourist/label','package_price'),
//                            'filter'        => false,
//                            'type'          => 'raw',
//                            'value'         => function($data){
...
//                        ),
                        array(
                            ...
                            'type'          => 'raw',
                            'value'         => function($data){
                                $value = number_format($data->total_money,0,',','.');
                                return $value;
                            },
                            'htmlOptions'   => array('style' => 'vertical-align: center; text-align: right'),
                            'headerHtmlOptions'   => array('style' => 'text-align: center'),
