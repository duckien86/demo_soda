...
<div id="order">
    <?php $this->widget('booster.widgets.TbGridView', array(
        ...
        'columns'           => array(
            ...
            array(
                'name'        => 'contract_code',
                'value'       => 'CHtml::encode(TContracts::getContractCodeByOrder($data))',
            ),
            array(
...
//            ),
            ...
            array(
                ...
                'value'       => function($data){
                    ...
                    $text = CHtml::encode(TOrders::getOrdersStatusLabel($data));
            ...
            array(
                ...
                'value'       => function ($data) {
                    ...
                    if($data->status >= TOrders::ORDER_ASSIGNED){
                        $href = Yii::app()->createUrl("order/report", array("id"=>$data->id));
                    }else{
...
//                        'url'     => function($data){
//                            if($data->status >= TOrders::ORDER_ASSIGNED){
//                                return Yii::app()->createUrl("order/report", array("id"=>$data->id));
//                            }else{
            ...
            array(
                ...
                'buttons'     => array(
                    ...
                    'upload' => array(
                        ...
                        'url'     => function($data){
                            return Yii::app()->createUrl('order/uploadMoreSim', array('id' => $data->id));
                        },
