...
<table id="contract-package" class="table table-striped table-responsive">
    ...
    <tbody>
        ...
        foreach ($list_packages as $package) {
            ...
            $this->renderPartial('/order/_order_item2', array(
                'package' => $package,
                'order'   => $order,
            ...
            $order_total_price += TOrders::getItemTotalPrice($order, $package, $contract_detail,($order->quantity));
    ...
    <tfoot>
        <tr>
            <td colspan="4" class="text-center"><?php echo CHtml::encode(Yii::t('tourist/label','order_total_price'))?></td>
