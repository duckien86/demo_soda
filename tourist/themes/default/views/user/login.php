...
<div id="login" class="container text-center">
    <div class="modal-login">
        ...
        <div class="form-title-description">
            <p><i><?php echo CHtml::encode(Yii::t('tourist/label', 'login_note_1'))?></i></p>
...
//            ),
        ...
        <div class="form-group">
            ...
            <a id="btn-forget-password" href="<?php echo Yii::app()->createUrl('user/forgetPassword');?>">
                <?php echo Yii::t('tourist/label', 'forget_password'); ?>
            </a>
        </div>
