<?php
    ...
    class CskhLogMtController extends AController
    {
        /**
            ...
            if (isset($_POST['ReportForm']) || isset($_REQUEST['ReportForm'])) {
                ...
                if ($form_validate->validate()) {
                    ...
                    $data = new CArrayDataProvider($data, array(
                        ...
                        'pagination' => array(
                            'params'   => array(
                                "ReportForm[start_date]" => $_POST['ReportForm']['start_date'],
                                "ReportForm[end_date]"   => $_POST['ReportForm']['end_date'],
                                "ReportForm[msisdn]"     => $_POST['ReportForm']['msisdn'],
                            ),
                            'pageSize' => 30,
                        ),
                    ));
