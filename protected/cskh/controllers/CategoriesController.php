...
//			'accessControl', // perform access control for CRUD operations
        ...
        public function actionView($id)
        {
            if (isset($_GET['id'])) {
                ...
                return $this->render('_detail_complain', array('model' => $model, 'categories_id' => $_GET['id']));
            }
        }
         ...
         * @return string
         */
        public function actionDetaiCatgories()
        {
        ...
        public function actionChangeStatus()
        {
            ...
            $status = Yii::app()->getRequest()->getParam('status', 0);

            $model = Categories::model()->findByAttributes(array('id' => $id));
            if ($model) {
                $model->status = $status;
                if ($model->update()) {
                    $result = TRUE;
