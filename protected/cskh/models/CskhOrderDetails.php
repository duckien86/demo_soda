<?php
    ...
    class CskhOrderDetails extends OrderDetails
    {
         ...
         *
         * @return CskhOrderDetails the static model class
         */
        ...
        public static function getItemPrice($order_id)
        {
            $orders = CskhOrderDetails::model()->findByAttributes(array('order_id' => $order_id, 'type' => 'price_term'));
            if ($orders) {
                return $orders->price;
            }
