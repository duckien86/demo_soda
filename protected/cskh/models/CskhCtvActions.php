<?php
     ...
     */
    class CskhCtvActions extends CActiveRecord
    {
...
//                array('action_id, transaction_id, publisher_id, amount, action_status, created_on, order_code, product_name', 'required'),
         ...
         *
         * @return CskhCtvActions the static model class
         */
        ...
        public function getTotal($type, $user_id)
        {
            ...
            $data = CskhCtvActions::model()->count($criteria);
        ...
        public function getRenueve($type, $user_id)
        {
            ...
            $data = isset(CskhCtvActions::model()->findAll($criteria)[0]->total_renueve) ? CskhCtvActions::model()->findAll($criteria)[0]->total_renueve : 0;
        ...
        public function getCommision($type, $user_id)
        {
            ...
            $data = isset(CskhCtvActions::model()->findAll($criteria)[0]->total_commision) ? CskhCtvActions::model()->findAll($criteria)[0]->total_commision : 0;
        ...
        public function getDetailsCommision($type, $user_id, $post = 1)
        {
            ...
            $data = new CActiveDataProvider('CskhCtvActions', array(
                'criteria'   => $criteria,
                ...
                'pagination' => array(
                    'params'   => array(
                        ...
                        "CskhCtvActions[info_search]" => $this->info_search,
                        "CskhCtvActions[input_type]"  => $this->input_type,
                    ),
                    'pageSize' => 30,
                ),
