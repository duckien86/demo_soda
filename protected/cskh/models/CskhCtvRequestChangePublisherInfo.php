<?php
     ...
     */
    class CskhCtvRequestChangePublisherInfo extends CActiveRecord
    {
...
//            $criteria->compare('status', $this->status);
         ...
         *
         * @return CskhCtvRequestChangePublisherInfo the static model class
         */
        ...
        {
            if ($user_id) {
                $users_request_change = CskhCtvRequestChangePublisherInfo::model()->findByAttributes(array('publisher_id' => $user_id));
