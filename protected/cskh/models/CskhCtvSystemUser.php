<?php
     ...
     */
    class CskhCtvSystemUser extends CActiveRecord
    {
         ...
         *
         * @return CskhCtvSystemUser the static model class
         */
        ...
        {
            $rs = CskhCtvSystemUser::model()->findAll();
            if ($rs) {
        ...
        {
            if ($user_id) {
                $system_user = CskhCtvSystemUser::model()->findByAttributes(array('id' => $user_id));
