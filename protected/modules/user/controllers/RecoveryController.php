...
//			    					));
                            ...
                            $email_content = $this->renderPartial('_email_content_forget_pass', array('url_changepass' => $activation_url, 'username' => $user->username), TRUE);
                            UserModule::sendEmail('Freedoo - Khôi phục mật khẩu admin', $user->email, '', '', $email_content, 'user.views.sendEmail');
