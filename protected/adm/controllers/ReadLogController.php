<?php
    ...
    class ReadLogController extends AController
    {
        ...
        public function init()
        {
            ...
            $folder              = isset($_GET['p']) ? $_GET['p'] : FALSE;
            if ($folder) {
                Yii::app()->session['mode'] = Yii::app()->basePath . "/$folder/runtime";
            }
            if (!isset(Yii::app()->session['mode'])) {
                Yii::app()->session['mode'] = Yii::app()->basePath . "/web/runtime";
            }

            $this->root_path = Yii::app()->session['mode'];
            // Hiện tất cả thư mục ngày  09/10/2017
