...
//                'postOnly + delete', // we only allow deletion via POST request
        ...
        public function actionCreate()
        {
            ...
            if (isset($_POST['ANews'])) {
                ...
                if ($model->save()) {
                    //add to cache
//                    ANews::getListNewsByType($model->hot);
...
//                    ANews::getListNewsByType($model->hot);
        ...
        public function loadModel($id)
        {
            ...
            if(!empty($model->last_update)){
                $model->last_update = date('d/m/Y', strtotime($model->last_update));
            }
            return $model;
        }
        ...
        public function actionUpload()
        {
            ...
            $max_upload_size   = 53000;
            $accept_file_types = 'jpg|jpeg|png|gif';
            $options_arr       = array(
                'script_url'        => Yii::app()->createUrl('aNews/delete'),
