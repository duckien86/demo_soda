...
//                    }
         ...
         *
         * @param ATraffic $model the model to be validated
         */
            ...
            if ($id) {
                ...
                if ($check) {
                    if ($check->sale_office_code != '') {
                        if ($check->shipper_id != '') {
                            $criteria->condition = "status = 1 AND sale_offices_code ='" . $check->sale_office_code . "' and id !='" . $check->shipper_id . "'";
                        } else {
                            $criteria->condition = "status = 1 AND sale_offices_code='" . $check->sale_office_code . "'";
                        }
                    }
                }
        ...
        public function actionAssignmentShipper()
        {
            ...
            if ($shipper_id && $order_id && $email) {
                ...
                $model_order  = AOrders::model()->findByAttributes(array('id' => $order_id));
