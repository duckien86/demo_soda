...
//			'postOnly + delete', // we only allow deletion via POST request
    ...
    /*
     * Tra cứu đơn hàng fiber
     */
    public function actionSearchFiber()
    {
        ...
        if (isset($_REQUEST['AOrders'])) {
            $model->attributes = $_REQUEST['AOrders'];
            if ($model->id == '' && $model->full_name == '' && $model->phone_contact == '' && $model->province_code == '' && $model->start_date == '' && $model->end_date == '') {
                $model->validate();
                $this->render('search_fiber', array(
                    'model' => $model,
                ));
            } else {
    ...
    /*
     * Chi tiết đơn hàng fiber
     */
    public function actionDetailOrderFiber()
    {
        $model = new AOrders('search_fiber');
        ...
        if (isset($_REQUEST['AOrders'])) {
            $model->attributes = $_REQUEST['AOrders'];
            $data_total = $model->getDetailOrderFiber(false);
            $data = $model->getDetailOrderFiber(true);

        }
        $this->render('detail_order_fiber', array(
            'model' => $model,
            'data' => $data,
