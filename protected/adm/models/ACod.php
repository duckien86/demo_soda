<?php
    ...
    class ACod
    {
        ...
        {
            $this->end_point = Yii::app()->controller->createUrl('aCheckout/verifyTokenKey');
        }
            ...
            if ($token_key) {
                ...
                if (YII_DEBUG == TRUE) {
                    ...
                    if (OtpForm::sentMtVNP($ordersObj->phone_contact, $mt_content, 'cod')) {
                        ...
                        $urlRequest = Yii::app()->controller->createUrl('aCheckout/message', array('t' => 9));
                    }
                }
            } else {//get token key fail
                $msg        = Yii::t('web/portal', 'get_token_key_fail');
                $urlRequest = Yii::app()->controller->createUrl('aCheckout/message', array('t' => 8));
            }
