<?php
     ...
     */
    class APointHistory extends PointHistory
    {
        ...
        public function attributeLabels()
        {
            return array(
                ...
                'create_date'   => 'Ngày cập nhật điểm',
                'note'          => 'Ghi chú',
                'sso_id'        => 'sso_id',
            );
        }
         ...
         * Đổi sự kiện.
         */
        public function convertEvent($event, $type)
        {
            $result = "";
            if ($type == self::TYPE_ADD) {
                if ($event == ACustomers::POINT_EVENT_COMMENT) {
                    $result = "Bình luận bài viết";
                } else if ($event == ACustomers::POINT_EVENT_POST) {
                    $result = "Đăng bài viết";
                } else if ($event == ACustomers::POINT_EVENT_REDEEM) {
                    $result = "Đổi quà";
                }
            } else {
                if ($event == ACustomers::POINT_EVENT_COMMENT) {
                    $result = "Bị ẩn bình luận";
                } else if ($event == ACustomers::POINT_EVENT_POST) {
                    $result = "Bị ẩn bài viết";
                } else if ($event == ACustomers::POINT_EVENT_REDEEM) {
                    $result = "Đổi quà";
                }
            }
