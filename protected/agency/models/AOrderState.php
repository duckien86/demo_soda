<?php
    ...
    class AOrderState extends OrderState
    {
        const UNCONFIRMED     = 0;
        const CONFIRMED       = 10;
        const CANCEL_PASS     = 2;
         ...
         *
         * @return AOrderState the static model class
         */
        ...
        public static function getDetailOrder($order_id)
        {
            ...
            return new CActiveDataProvider('AOrderDetails', array(
                'criteria' => $criteria,
            ));
        ...
        public function getTypeOfProduct($product, $type = 0)
        {
            ...
            if ($type == 1) {
                ...
                $package = APackage::model()->findByAttributes(array('name' => $product));
                if ($package) {
                    return self::getType($package->type);
                }
            } else {
                $sim = Sim::model()->findByAttributes(array('order_id' => $product));
                if ($sim) {
         ...
         */
        public function setOrderState(AOrders $modelOrder, AOrderState &$order_state, $confirm = '', $paid = '', $delivered = '')
        {
