<?php
    ...
    class AReportAT
    {
        ...
        public function getSimOverView()
        {
            ...
            if ($this->start_date && $this->end_date) {
                $criteria->condition = "create_date >= '$this->start_date' and create_date <='$this->end_date'";
            }
        ...
        public function getSimDetails($excel = FALSE)
        {
            ...
            $criteria = new CDbCriteria();
            if ($this->start_date && $this->end_date) {
                $criteria->condition = "order_create_date >= '$this->start_date' and order_create_date <='$this->end_date'";
            }
            if ($this->province_code != '') {
                $criteria->addCondition("order_province_code ='" . $this->province_code . "'");
            }
