...
class ALocationNapas extends LocationNapas
{
    ...
    public static $VPC_ACCESS_CODE     = 'V1IN3APHO5N7EON8LI0NE';
    public static $VPC_MERCHANT        = 'VINAPHONEONLINE';
    public static $SECURE_SECRET       = '1D08B1EC51396B1132F827469E27C102';
    public static $END_POINT           = 'https://payment.napas.com.vn/gateway/vpcpay.do';
    ...
    public function beforeSave()
    {
        ...
        if(empty($this->vpc_AccessCode)){
            $this->vpc_AccessCode = self::$VPC_ACCESS_CODE;
        }
        if(empty($this->vpc_Merchant)){
            $this->vpc_Merchant = self::$VPC_MERCHANT;
        }
        if(empty($this->secure_secret)){
