<?php
    ...
    class ALikes extends Likes
    {
        ...
        public function attributeLabels()
        {
            return array(
                'id'                 => 'ID',
                'sc_tbl_posts_id'    => 'Bài viết',
                'sc_tbl_comments_id' => 'Comment của bài viết',
                'sso_id'             => 'Sso',
                'create_date'        => 'Ngày likes',
            );
        }
        ...
        {
            $comment = AComments::model()->findByAttributes(array('id' => $id));

            return ($comment) ? $comment->content : 'Chưa like bình luận nào của bài viết';
        }
    }
