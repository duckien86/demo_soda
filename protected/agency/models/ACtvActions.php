<?php
     ...
     */
    class ACtvActions extends CActiveRecord
    {
...
//                array('action_id, transaction_id, publisher_id, amount, action_status, created_on, order_code, product_name', 'required'),
                ...
                array('order_time, note, extra_params, package_code, msisdn', 'safe'),
         ...
         *
         * @return ACtvActions the static model class
         */
        ...
        public function getTotal($type, $user_id)
        {
            ...
            $data = ACtvActions::model()->count($criteria);
        ...
        public function getRenueve($type, $user_id)
        {
            ...
            $data = isset(ACtvActions::model()->findAll($criteria)[0]->total_renueve) ? ACtvActions::model()->findAll($criteria)[0]->total_renueve : 0;
        ...
        public function getCommision($type, $user_id)
        {
            ...
            $data = isset(ACtvActions::model()->findAll($criteria)[0]->total_commision) ? ACtvActions::model()->findAll($criteria)[0]->total_commision : 0;
        ...
        public function getDetailsCommision($type, $user_id, $post = 1)
        {
            ...
            $data = new CActiveDataProvider('ACtvActions', array(
                ...
                'pagination' => array(
                    'params'   => array(
                        'ACtvActions[start_date]'  => $this->start_date,
                        'ACtvActions[end_date]'    => $this->end_date,
                        "ACtvActions[type]"        => $type,
                        "ACtvActions[info_search]" => $this->info_search,
                        "ACtvActions[input_type]"  => $this->input_type,
                    ),
                    'pageSize' => 30,
                ),
