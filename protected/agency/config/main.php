<?php
    $agency  = dirname(dirname(__FILE__));
    $base = dirname($agency);
    Yii::setPathOfAlias('agency', $agency);
    ...
    $agencyArray = array(
        ...
        'controllerPath'    => $agency . '/controllers',
        'viewPath'          => $agency . '/views',
        'runtimePath'       => $agency . '/runtime',
        ...
        'modules'           => array(
            'user' => array(
                ...
                # login form path
                'loginUrl'            => array('/user/loginAgency'),

                # page after login
                'returnUrl'           => array('/user/profile'),

                # page after logout
                'returnLogoutUrl'     => array('/user/loginAgency'),
            ),
...
//                        'baseUrl'=>'/rights', // Base URL for Rights. Change if module is nested.
        ...
        'components'        => array(
            ...
            'request'      => array(
                'class'                  => 'agency.components.HttpRequest',
    ...
    return w3_array_union_recursive($agencyArray, $baseArray);
?>