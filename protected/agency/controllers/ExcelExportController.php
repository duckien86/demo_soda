    ...
    class ExcelExportController extends AController
    {
            ...
            if (isset($_POST['excelExport'])) {
                ...
                foreach ($data_detail as $item) {
                    ...
                    $results[$i] = array(
                        ...
                        'SUM_REVENUE'       => $item->renueve_sim + $item->renueve_package + $item->renueve_term
                    );
                    $i++;
        ...
        public function actionReportOnlinePaid()
        {
            ...
            if (isset($_POST['excelExport'])) {
                ...
                $file_name = "Doanh thu thanh toán Online" . $_POST['excelExport']['start_date'] . " đến " . $_POST['excelExport']['end_date'];
        ...
        public function actionReportPackage()
        {
            ...
            if (isset($_POST['excelExport'])) {
                ...
                if (!empty($data)) {
                    ...
                    $file_name = "Doanh thu gói cước dịch vụ đơn lẻ từ $model->start_date đến $model->end_date";
            ...
            if (isset($_POST['excelExport'])) {
                ...
                if (!empty($data)) {
                    ...
                    foreach ($data as $item) {
                        $result[$i] = array(
                            'PROVINCE'          => $list_province[$item->province_code],
                            'SALE_OFFICE'       => $list_sale_office[$item->id],
                            'ORDER_CODE'        => $item->id,
                            'CREATE_DATE'       => $item->create_date,
                ...
                if (!empty($data)) {
                    ...
                    foreach ($data as $item) {
                        ...
                        $result[$stt] = array(
                            ...
                            'REASON'            => $order_note,
                            'ACTIVE_DATE'       => AOrders::model()->getActiveSimDate($item->order_id),
...
//                    'RENEWAL_COUNT'     => 'Số lần gia hạn',
                ...
                if (!empty($data)) {
                    ...
                    foreach ($data as $item) {
                        ...
                        $result[$stt] = array(
                            'PROVINCE'          => AProvince::model()->getProvinceVnp($item['vnp_province_id']),
