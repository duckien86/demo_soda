...
//			'postOnly + delete', // we only allow deletion via POST request
        ...
        public function actionAdmin()
        {
            ...
            if (isset($_GET['AOrders'])) {
                ...
                if ($_GET['AOrders']['period'] != '') {
                    $model->period = $_GET['AOrders']['period'];
                    $post = TRUE;
                }
                if ($_GET['AOrders']['status_shipper'] != '') {
                    $model->status_shipper = $_GET['AOrders']['status_shipper'];
                    $post = TRUE;
                }
            }
            ...
            if (isset($_POST['AOrders'])) {
                ...
                if ($_POST['AOrders']['period'] != '') {
                    $model->period = $model_search->period = $_POST['AOrders']['period'];
                }
                $model->status_shipper = $model_search->status_shipper = $_POST['AOrders']['status_shipper'];
