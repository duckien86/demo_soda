    ...
    class APackage extends Package
    {
        ...
        public function rules()
        {
            ...
            return array(
                ...
                array('type, status, vip_user, sort_index', 'numerical', 'integerOnly' => TRUE),
                array('id', 'length', 'max' => 100),
                array('name, code, short_description, thumbnail_1, thumbnail_2, thumbnail_3, extra_params', 'length', 'max' => 255),
