...
/**
 * This is the model class for table "{{commisions_sim_details}}".
 *
 * The followings are the available columns in table '{{commisions_sim_details}}':
 * @property string $id
 ...
 */
class CommisionsSimDetails extends CActiveRecord
{
	/**
