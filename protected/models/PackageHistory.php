...
/**
 * This is the model class for table "{{package_history}}".
 *
 * The followings are the available columns in table '{{package_history}}':
 * @property integer $id
 ...
 */
class PackageHistory extends CActiveRecord
{
	/**
	 ...
	 * @return PackageHistory the static model class
	 */
