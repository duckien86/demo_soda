...
/**
 * This is the model class for table "{{register_package}}".
 *
 * The followings are the available columns in table '{{register_package}}':
 * @property string $id
 * @property string $so_tb
 * @property string $create_date
 * @property string $action
 * @property string $package_code
 */
class RegisterPackage extends CActiveRecord
{
	/**
