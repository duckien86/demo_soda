...
/**
 * This is the model class for table "{{commission_sim_by_date}}".
 *
 * The followings are the available columns in table '{{commission_sim_by_date}}':
 * @property string $id
 ...
 */
class CommissionSimByDate extends CActiveRecord
{
	/**
