            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($model,'type_search_date', ACardStore::getListTypeSearchDate(), array(
                            'class' => 'form-control',
                        ))?>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <?php echo $form->dropDownList($model,'status',ACardStore::getListStatus(), array(
                            'class' => 'form-control',
                            'empty' => 'Tất cả',
                        ))?>
                    </div>
