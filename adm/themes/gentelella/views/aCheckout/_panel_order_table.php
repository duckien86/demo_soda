...
<tr>
    ...
    <td class="fr txt_value">
             <span id="order_sim_type_txt">
                <?= ($modelSim->type == ASim::TYPE_POSTPAID) ? Yii::t('web/portal', 'postpaid') : Yii::t('web/portal', 'prepaid') ?>
             </span>
    </td>
</tr>
<tr>
...
<?php if ($modelSim->type == ASim::TYPE_POSTPAID && isset($modelSim->price_term) && ($modelSim->price_term > 0)): ?>
    <tr>
        <td class="fl">
                <span class="txt_label">
                    Cước cam kết
...
<?php endif; ?>
<?php if ($modelSim->type == ASim::TYPE_PREPAID && isset($modelPackage->price)): ?>
    <tr>
        <td class="fl">
                <span class="txt_label">
                    Giá gói cước
...
<tr>
    <td class="fl note">
        <?php if ($modelSim->type == ASim::TYPE_POSTPAID): ?>
