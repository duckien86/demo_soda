                ...
                <div class="col-md-8 col-md-pull-4 no_pad_xs">
                    <div id="main_left_section" class="msg">
                        ...
                        <div>
                            ...
                            <?php
                                //delivery_type=shop
                                if (isset(Yii::app()->session['message_order']['delivery_type']) && Yii::app()->session['message_order']['delivery_type'] == AOrders::DELIVERY_TYPE_SHOP):
                                    $time = time();
                                ...
                                <?php else: ?>
                                    ...
                                    if (isset(Yii::app()->session['message_order']['payment_method']) &&
                                        (Yii::app()->session['message_order']['payment_method'] != APaymentMethod::PM_COD || Yii::app()->session['message_order']['payment_method'] != APaymentMethod::PM_AIRTIME)
                                    ): ?>
                        ...
                        <div class="space_10"></div>
                        <div class="text-center">
                            <?php echo CHtml::link(Yii::t('web/portal', 'homepage'), Yii::app()->controller->createUrl('aSite/index'),
