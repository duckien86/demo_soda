<div class="x_panel">
    <div class="x_title">
        <h3>Hoa hồng phát triển gói cước</h3>
    </div>
                        ...
                        <?php if (isset($data_renueve) && !empty($data_renueve)): ?>
                            ...
                            foreach ($data_renueve as $renueve) {
                                ...
                                <tr>
                                    ...
                                    <td><?= isset($renueve['total_package']) ? $renueve['total_package'] : ''; ?></td>
                                    <td style="text-align: right;"><?= (isset($renueve['total_package']) && isset($renueve['package_price'])) ? number_format($renueve['total_package'] * $renueve['package_price'], 0, "", ".") . " đ" : ''; ?></td>
