        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <?php echo $form->dropDownList($model, 'status_shipper', $model->getAllStatusAdmin(), array(
                            'class' => 'form-control',
                            'empty' => 'Chọn tất cả',
                        )
                    ); ?>
                ...
                <div class="form-group">
                    ...
                    <?php
                        echo CHtml::activeDropDownList(
                            $model,
                            'delivery_type',
                            $model->getAllDeliveredType(),
                            array('empty' => Yii::t('report/menu', 'delivery_type'), 'class' => 'dropdownlist form-control')
                        )
                    ?>
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    ?>
                    <?php echo $form->error($model_validate, 'brand_offices_id'); ?>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
...
//            timePicker: true,
    ...
    $('#ATraffic_delivery_type').change(function () {
        if ($(this).val() == '1') {
            $("#ATraffic_brand_offices_id").select2("val", "")
        }
    });
