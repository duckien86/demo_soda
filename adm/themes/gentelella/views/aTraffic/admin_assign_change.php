...
$this->breadcrumbs = array(
    ...
    'Điều chuyển NV giao vận' => array('adminAssignChange'),
);
    //    $data_overview     = array(
    //        'total_not_assign' => count($model->search_assign(2, FALSE)->getData()),
    //        'total_assign'     => count($model->search_assign(1, FALSE)->getData()),
    //    );
?>
<div class="x_panel">
    <div class="x_title">
        <h2><?= Yii::t('adm/menu', 'assignment_change_shipper'); ?></h2>
        ...
        <div class="x_content">
            ...
            <div class="table-responsive tbl_style center">
                <?php $this->widget('booster.widgets.TbGridView', array(
                    ...
                    'dataProvider'  => $model->search_assign_change(),
                    'filter'        => $model,
                    'enableSorting' => FALSE,
                    'type'          => 'post',
                    'columns'       => array(
