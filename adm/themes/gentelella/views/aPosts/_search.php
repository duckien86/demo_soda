...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'total_comment',array('size'=>10,'maxlength'=>10)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'total_like'); ?>
		<?php echo $form->textField($model,'total_like',array('size'=>10,'maxlength'=>10)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'post_category_id'); ?>
		<?php echo $form->textField($model,'post_category_id',array('size'=>11,'maxlength'=>11)); ?>
	</div>
