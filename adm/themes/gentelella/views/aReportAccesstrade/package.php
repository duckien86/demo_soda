<div class="x_panel">
    <div class="x_title">
        <h3><?= Yii::t('adm/label', 'report_at_package') ?></h3>
    </div>
    ...
    <div class="row" style="margin-top: 20px;">
        <?php if ($post == 1 && isset($data) && !empty($data)):
                ...
                <?php $this->widget('booster.widgets.TbGridView', array(
                    ...
                    'columns'       => array(
                        array(
                            'name'        => 'item_id',
                            'value'       => function ($data) {
                                return CHtml::encode(AReportATForm::getPackageByCode($data->item_id));
                            },
            ...
            <div class="col-md-12">
                ...
                <form method="post"
                      action="<?php echo Yii::app()->createAbsoluteUrl('excelExport/reportPackageAt'); ?>"
                      name="fday">
                    ...
                    <input type="hidden" name="excelExport[channel_code]"
                           value="<?php echo $form->channel_code ?>">
                ...
                <?php $this->widget('booster.widgets.TbGridView', array(
                    ...
                    'columns'       => array(
                        ...
                        array(
                            'name'        => 'phone_customer',
                            'value'       => function ($data) {
                                return CHtml::encode($data->phone_customer);
                            },
                            'htmlOptions' => array('style' => 'text-align: left;word-break: break-word;vertical-align:middle;width:100px;'),
                        ),
                        array(
                        ...
                        array(
                            'name'        => 'package_type',
                            'value'       => function ($data) {
                                return CHtml::encode(AReportATForm::getPackageGroupByType($data->package_type));
                            },
                            'htmlOptions' => array('style' => 'text-align: left;word-break: break-word;vertical-align:middle;'),
                        ),
                        array(
...
//                                }
                        ...
                        array(
                            'header'      => 'Doanh thu gói đầu tháng',
                            'value'       => function ($data) {
                                $date = date('Y-m-d', strtotime($data->order_create_date));
                                if($date < '2018-09-01'){
                                    $value = ($data->item_price_original == 0) ? 0 : $data->item_price;
                                }else{
                                    $value = $data->item_price_original;
                                }
