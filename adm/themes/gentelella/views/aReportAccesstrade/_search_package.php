        ...
        <tr>
            ...
            <td>
                <div class="input-prepend input-group">
                    ...
                    <?php
                        echo $form->textField($model, 'end_date', array('class' => 'form-control', 'size' => 30, 'maxlength' => 50));
                    ?>
                </div>
        ...
        <tr>
            ...
            <td><?php
                    echo CHtml::activeDropDownList(
                        $model,
                        'package_group',
                        $model->getPackageGroup(),
                        array('empty' => Yii::t('report/menu', 'package_group'), 'class' => 'dropdownlist form-control')
                    )
                ?>
            </td>
        ...
        <tr>
            ...
            <td><?php
                    echo CHtml::activeDropDownList(
                        $model,
                        'package_id',
                        ($model->package_group != '') ? $model->getPackageByGroup($model->package_group) : $model->getAllPackage(),
