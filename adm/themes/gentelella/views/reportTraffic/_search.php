...
<div class="fillterarea form">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <?php echo $form->dropDownList($model, 'channel_code', $model->getAllChannel(), array(
                    'empty' => 'Tất cả',
        ...
        <tr>
            <td><?php echo $form->label($model, 'utm_campaign'); ?>:</td>
            <td>
                <?php echo $form->dropDownList($model, 'utm_campaign', $model->getAllCampaign(), array(
                    'empty' => 'Tất cả',
                    'class' => 'dropdownlist form-control',
                )); ?>
            </td>
