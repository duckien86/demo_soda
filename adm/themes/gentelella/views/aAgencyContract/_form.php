...
<!--            </div>-->
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model, 'agency_id', array('class' => 'col-md-3')); ?>
                <div class="col-md-9">
                    <?php $this->widget(
                        ...
                        array(
                            'model'       => $model,
                            'attribute'   => 'agency_id',
                            'data'        => CHtml::listData(AAffiliateManager::model()->findAllByAttributes(array('type' => AAffiliateManager::TYPE_AGENCY)), 'code', 'name'),
                            'htmlOptions' => array(
                                'class'     => 'form-control',
                                'multiple'  => FALSE,
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#AAgencyContract_start_date').daterangepicker({
...
//            timePicker: true,
        ...
        $('#AAgencyContract_finish_date').daterangepicker({
            singleDatePicker: true,
            showDropdowns: true,
//            timePicker: true,
            timePickerIncrement: 5,
