...
<div class="form">
    ...
    <div class="form-group">
        ...
        <div id="progress" class="progress col-md-6 col-sm-12 col-xs-12 no_pad">
...
<script>
    ...
    $(function () {
        ...
        var url = '<?php echo Yii::app()->controller->createUrl('aNewsCategories/upload/', array('qqfile' => '1'))?>';
    ...
    function previewThumbnail() {
        ...
        $.ajax({
            url: '<?=Yii::app()->controller->createUrl('aNewsCategories/images')?>',
            type: "POST",
            dataType: "json",
            data: form_data,
