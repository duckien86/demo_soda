...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <?php echo $form->textField($model, 'description', array('class' => 'textbox', 'maxlength' => 255)); ?>
        <ul class="parsley-errors-list">
...
<?php if (Rights::module()->enableBizRule === true): ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <?php echo $form->textField($model, 'bizRule', array('class' => 'textbox', 'maxlength' => 255)); ?>
            <ul class="parsley-errors-list">
...
<?php if (Rights::module()->enableBizRule === true && Rights::module()->enableBizRuleData): ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <?php echo $form->textField($model, 'data', array('class' => 'textbox', 'maxlength' => 255)); ?>
            <ul class="parsley-errors-list">
...
<div class="form-group">
    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
        <span class="btnintbl">
            <span class="icondk">
                <?php echo CHtml::submitButton(Rights::t('core', 'Save')); ?>
            </span>
        </span> |
        <span class="btnintbl">
            <span class="icondk">
