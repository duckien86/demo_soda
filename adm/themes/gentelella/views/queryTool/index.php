...
<div class="col-md-3">
    ...
    <div class="row">
        <?php echo CHtml::radioButtonList('db_type', $db_type, array(
            'oracle'                => 'Oracle',
            'db'                    => 'My sql - DB Freedoo',
            'db_freedoo_tourist'    => 'My sql - DB Tourist',
            'db_affiliates'         => 'My sql - DB Affiliates'
        )); ?>
    </div>
</div>
<div class="col-md-3">
...
<div class="row">
    <?php
        if ($dataProvider) {
            ...
            $this->renderPartial('/queryTool/_export');
