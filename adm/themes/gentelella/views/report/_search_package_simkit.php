...
<div class="fillterarea form">
    ...
    <table>
            ...
            <td><?php
                    $this->widget(
                        ...
                        array(
                            ...
                            'data'        => CHtml::listData(APackage::model()->findAll(), 'code', 'name'),
                            'htmlOptions' => array(
                                'multiple' => FALSE,
        ...
        <tr>
            ...
            <td>
                <?php echo $form->dropDownList($model,'sim_type',array(
                    ASim::TYPE_PREPAID => 'Trả trước',
                    ASim::TYPE_POSTPAID => 'Trả sau',
                ), array(
                    'class' => 'form-control',
                ))?>
            </td>
